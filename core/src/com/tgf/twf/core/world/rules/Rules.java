...
public class Rules {
    ...
    public static final Inventory CONSTRUCT_COST = SingleResourceTypeInventory.ONE_FOOD;
    ...
    public static final Inventory PLANT_COST = SingleResourceTypeInventory.ONE_FOOD;
