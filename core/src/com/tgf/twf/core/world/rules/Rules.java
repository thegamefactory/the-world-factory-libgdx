...
public class Rules {
    ...
    public static final Inventory CONSTRUCT_COST = Action.Cost.ONE_FOOD;
    ...
    public static final Inventory HARVEST_COST = Action.Cost.ONE_FOOD;
    ...
    public static final Inventory PLANT_COST = Action.Cost.ONE_FOOD;
