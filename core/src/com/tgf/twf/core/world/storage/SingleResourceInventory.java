 ...
 */
@AllArgsConstructor
public class SingleResourceInventory implements MutableInventory {
    private final ResourceType resourceType;
    private int quantity;

    public static SingleResourceInventory of(final ResourceType resourceType, final int quantity) {
        return new SingleResourceInventory(resourceType, quantity);
    }
